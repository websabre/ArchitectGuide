"""Hand-crafted premium interview banks for Weeks 47–48 — System Design & Whiteboard Mocks.
...
WEEK_47_INTERMEDIATE = [
    ...
    q("CAP Theorem System Design", "Distributed Systems", "Very Common",
    ...
    q("Read Replicas System Design", "Data Scale", "Very Common",
    ...
    q("Database Sharding Strategy", "Data Scale", "Very Common",
    ...
    q("API Gateway System Design", "API Design", "Very Common",
    ...
    q("Outbox Pattern Design", "Messaging", "Very Common",
    ...
    q("Consistent Hashing Cache", "Distributed Cache", "Very Common",
    ...
    q("Bloom Filter System Design", "Probabilistic Structures", "Common",
    ...
    q("WebSocket Gateway Scale", "Real-Time", "Common",
    ...
    q("Multi-Region System Design", "Global Scale", "Common",
    ...
    q("Observability in System Design", "Observability", "Very Common",
...
WEEK_47_ADVANCED = [
    q("Dual Write Outbox Fix", "Messaging", "Very Common",
      ...
      "No relay monitoring"),
    q("Feed Fanout Hybrid Deep Dive", "System Design", "Very Common",
    ...
    q("URL Shortener Collision Strategy", "System Design", "Common",
    ...
    q("Chat Message Ordering", "System Design", "Very Common",
    ...
    q("Search Reindex Strategy", "System Design", "Common",
    ...
    q("Notification Dedup at Scale", "System Design", "Very Common",
    ...
    q("Saga Orchestration Temporal", "System Design", "Common",
    ...
    q("Circuit Breaker Cascade", "Resilience", "Very Common",
    ...
    q("Distributed Rate Limiter Sharding", "System Design", "Common",
    ...
    q("CDN Cache Stampede", "System Design", "Common",
    ...
    q("Hot Partition Cassandra", "System Design", "Common",
    ...
    q("Geographic Chat Routing", "System Design", "Common",
    ...
    q("Microservice Data Ownership", "System Design", "Very Common",
    ...
    q("Snowflake vs ULID", "System Design", "Common",
    ...
    q("Redis Cluster Failover", "Distributed Cache", "Common",
    ...
    q("Queue Ordering Throughput", "Messaging", "Common",
    ...
    q("Load Balancer Health Design", "System Design", "Common",
    ...
    q("Security in System Design", "Security", "Very Common",
    ...
    q("Viral Content Hot Key", "System Design", "Very Common",
    ...
    q("System Design Phased Evolution", "System Design", "Very Common",
    ...
    q("Presigned URL Security", "File Storage", "Common",
    ...
    q("Distributed Lock Design", "System Design", "Common",
    ...
    q("Idempotency Distributed API", "System Design", "Very Common",
    ...
    q("News Feed Cursor Pagination", "System Design", "Common",
    ...
    q("Cache Avalanche Mitigation", "System Design", "Very Common",
    ...
    q("Capacity Planning Interview", "System Design", "Common",
    ...
    q("Blob Storage Metadata Orphan", "File Storage", "Common",
    ...
    q("Search Personalization Layer", "System Design", "Common",
    ...
    q("Leader Election Service Design", "System Design", "Common",
...
WEEK_47_EXPERT = [
    q("Twitter Scale Panel Defense", "System Design", "Very Common",
    ...
    q("Payment Platform Design", "System Design", "Very Common",
    ...
    q("Black Friday Flash Sale", "System Design", "Very Common",
    ...
    q("Cross Region Active Active DB", "System Design", "Common",
    ...
    q("Celebrity Fanout Failure", "System Design", "Very Common",
    ...
    q("Cache Avalanche Product Launch", "System Design", "Very Common",
    ...
    q("Saga Compensation Walkthrough", "System Design", "Very Common",
    ...
    q("Skeptical Interviewer System Design", "Interview Skills", "Very Common",
    ...
    q("SQL vs NoSQL Under Pressure", "System Design", "Very Common",
    ...
    q("URL Shortener Full Mock Debrief", "Interview Skills", "Very Common",
    ...
    q("Chat Multi Region Split Brain", "System Design", "Common",
      ...
      "No sequence numbers"),
    q("Search Reindex Zero Downtime", "System Design", "Common",
    ...
    q("Notification Provider Outage", "System Design", "Very Common",
      ...
      "No fallback channel"),
    q("Rate Limiter Bypass Attack", "System Design", "Common",
    ...
    q("Microservices Blast Radius", "System Design", "Very Common",
      ...
      "Shared thread pool all dependencies"),
    q("Network Partition Consistency", "Distributed Systems", "Common",
    ...
    q("System Design Cost Optimization", "System Design", "Common",
    ...
    q("GDPR Delete Distributed", "System Design", "Common",
    ...
    q("Real Time Analytics Stream", "System Design", "Common",
    ...
    q("System Design Post Mortem Present", "Interview Skills", "Very Common",
...
WEEK_48_INTERMEDIATE = [
    ...
    q("Mock Opening Script", "Whiteboard Mock", "Very Common",
    ...
    q("Whiteboard Diagram Conventions", "Whiteboard Mock", "Very Common",
    ...
    q("Clarifying Questions Cheat Sheet", "Whiteboard Mock", "Very Common",
    ...
    q("Deep Dive Component Selection", "Whiteboard Mock", "Very Common",
    ...
    q("Failure Mode Brainstorming", "Whiteboard Mock", "Very Common",
    ...
    q("Trade Off Summary Template", "Whiteboard Mock", "Very Common",
    ...
    q("Mock Debrief Self Scoring", "Whiteboard Mock", "Very Common",
    ...
    q("Interviewer Redirect Handling", "Whiteboard Mock", "Very Common",
    ...
    q("Assumption Documentation Board", "Whiteboard Mock", "Very Common",
    ...
    q("Mock Pacing Time Signals", "Whiteboard Mock", "Very Common",
...
WEEK_48_ADVANCED = [
    q("Notification Exactly Once Debate", "Whiteboard Mock", "Very Common",
    ...
    q("Cart Inventory Race Mock", "Whiteboard Mock", "Very Common",
    ...
    q("Queue Priority Inversion Mock", "Whiteboard Mock", "Common",
    ...
    q("Pagination Keyset Seek Method", "Whiteboard Mock", "Common",
    ...
    q("Rate Limit Sliding Window Lua", "Whiteboard Mock", "Common",
    ...
    q("Auth Token Refresh Rotation", "Whiteboard Mock", "Very Common",
    ...
    q("Logging Injection Prevention", "Whiteboard Mock", "Common",
    ...
    q("Metrics Cardinality Control", "Whiteboard Mock", "Common",
    ...
    q("Deployment Canary Analysis", "Whiteboard Mock", "Common",
    ...
    q("Multi Tenant RLS PostgreSQL", "Whiteboard Mock", "Common",
    ...
    q("Read Replica Read After Write", "Whiteboard Mock", "Very Common",
    ...
    q("CQRS Projection Lag SLA", "Whiteboard Mock", "Very Common",
    ...
    q("Idempotency Distributed Race", "Whiteboard Mock", "Very Common",
    ...
    q("Schema Evolution Avro Compatibility", "Whiteboard Mock", "Common",
    ...
    q("Webhook Backoff Schedule", "Whiteboard Mock", "Very Common",
    ...
    q("Batch ETL Idempotent Partitions", "Whiteboard Mock", "Common",
    ...
    q("Stream Watermark Late Events", "Whiteboard Mock", "Common",
    ...
    q("Mock Security Pass Checklist", "Whiteboard Mock", "Very Common",
    ...
    q("Mock Cost Estimate Slide", "Whiteboard Mock", "Common",
    ...
    q("Mock Monitoring Golden Signals", "Whiteboard Mock", "Very Common",
    ...
    q("Mock Async vs Sync Decision", "Whiteboard Mock", "Very Common",
    ...
    q("Mock Bulkhead Thread Pools", "Whiteboard Mock", "Common",
    ...
    q("Mock Graceful Degradation Tiers", "Whiteboard Mock", "Common",
    ...
    q("Mock API Compatibility Matrix", "Whiteboard Mock", "Common",
    ...
    q("Mock Disaster Recovery Mention", "Whiteboard Mock", "Common",
    ...
    q("Mock Phased Rollout Narrative", "Whiteboard Mock", "Very Common",
    ...
    q("Mock Sequence Diagram Fast", "Whiteboard Mock", "Common",
    ...
    q("Mock Capacity Math Whiteboard", "Whiteboard Mock", "Very Common",
    ...
    q("Mock Data Model Normalization", "Whiteboard Mock", "Common",
    ...
    q("Mock Retry Idempotency Layers", "Whiteboard Mock", "Very Common",
...
WEEK_48_EXPERT = [
    q("Notification Mock Panel Defense", "Whiteboard Mock", "Very Common",
    ...
    q("Flash Sale Adversarial QA", "Whiteboard Mock", "Very Common",
    ...
    q("Multi Tenant Breach Scenario", "Whiteboard Mock", "Very Common",
    ...
    q("Zero Downtime Migration Mock", "Whiteboard Mock", "Common",
      ...
      "No rollback tested"),
    q("Webhook Scale Million Partners", "Whiteboard Mock", "Common",
    ...
    q("Stream Fraud False Positive", "Whiteboard Mock", "Common",
    ...
    q("Auth SAML Outage Fallback", "Whiteboard Mock", "Common",
    ...
    q("CQRS Read Model Corruption", "Whiteboard Mock", "Common",
    ...
    q("Schema Breaking Change Emergency", "Whiteboard Mock", "Common",
    ...
    q("Batch ETL Missed SLA Executive", "Whiteboard Mock", "Common",
    ...
    q("Mock Silent Interviewer", "Interview Skills", "Very Common",
    ...
    q("Mock Conflicting Requirements", "Interview Skills", "Very Common",
    ...
    q("Mock Time Overrun Recovery", "Interview Skills", "Very Common",
    ...
    q("Staff Mock Cost vs Reliability", "Interview Skills", "Very Common",
    ...
    q("Mock Defending Monolith Choice", "Interview Skills", "Common",
    ...
    q("Mock Multi Region Clock Skew", "System Design", "Common",
    ...
    q("Mock GDPR Right To Delete", "Whiteboard Mock", "Common",
      ...
      "No audit trail of deletion"),
    q("Mock Observability Budget Overrun", "Whiteboard Mock", "Common",
    ...
    q("Mock Panel Security Architect", "Interview Skills", "Very Common",
    ...
    q("Mock Retrospective Improvement", "Interview Skills", "Very Common",
