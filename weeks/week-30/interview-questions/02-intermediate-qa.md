...
1. **1. PR vs main pipeline? — PR: build+test only. Main: full deploy path.**
2. **2. Target CI time? — <15 min for PR feedback.**
...
## Q032: GitHub Actions OIDC to Azure
...
1. **1. AWS equivalent? — IAM OIDC trust to GitHub.**
2. **2. Self-hosted runners? — When VNet access to private resources required.**
...
## Q033: App Service Deployment Slots
...
1. **1. SignalR/WebSockets? — Drain connections before swap.**
2. **2. Cost? — Staging slot on same plan shares compute.**
...
## Q034: Blue-Green vs Canary vs Rolling
...
1. **1. Canary metrics? — 5xx rate, p99 latency, business conversion.**
2. **2. Database? — Expand-contract required for all except recreate.**
...
1. **1. latest tag? — Anti-pattern in production; use semver + git SHA label.**
2. **2. Config differences? — Outside artifact via Key Vault references.**
...
## Q036: Secret Management in Pipelines
...
1. **1. Secrets in ARM/Bicep? — Reference Key Vault secrets, never plain text.**
2. **2. CI access to Key Vault? — Separate OIDC scope for deploy-time only.**
...
## Q037: SAST and Dependency Scanning
...
1. **1. DAST? — Staging nightly, not every PR.**
2. **2. Alert fatigue? — Severity-based gates only.**
...
## Q038: Contract Testing with Pact
...
1. **1. Pact vs integration tests? — Pact is consumer-driven and faster.**
2. **2. Broker required? — Yes for sharing contracts across teams.**
...
## Q039: Database Migrations in CD
...
1. **1. Who approves prod migrations? — Automated for expand-only; manual for contract.**
2. **2. Rollback? — Tested forward-fix or down migration script.**
...
1. **1. Self-hosted runner security? — Harden VM, rotate tokens, network isolate.**
2. **2. Supply chain? — Pin action versions to commit SHA.**
...
## Q041: Pipeline as Code Principles
...
## Q042: Reusable GitHub Actions Workflows
...
## Q043: Environment Promotion Gates
...
## Q044: Immutable Artifacts in ACR
...
## Q045: Semantic Versioning in CI/CD
...
## Q046: Rollback Strategies in Production
...
## Q048: Integration Test Pyramid in Pipelines
...
## Q049: E2E Test Placement Strategy
...
## Q051: NuGet Cache Strategies in CI
...
## Q052: Self-Hosted Runners Trade-offs
...
## Q053: Deployment Approvals Design
...
## Q054: GitHub Environments Configuration
...
## Q055: Azure DevOps Multi-Stage YAML
...
## Q056: Container Image Scanning with Trivy
...
## Q059: Pipeline Secrets Rotation
...
## Q060: Failed Deploy Auto-Rollback
...
1. **How measure success? — Tie ci/cd pipeline purpose to SLI, DORA metric, or business KPI.**
2. **Common anti-pattern? — Adopting tools before understanding ci/cd pipeline purpose principles.**
...
1. **How measure success? — Tie github actions basics to SLI, DORA metric, or business KPI.**
2. **Common anti-pattern? — Adopting tools before understanding github actions basics principles.**
...
1. **How measure success? — Tie azure devops pipelines to SLI, DORA metric, or business KPI.**
2. **Common anti-pattern? — Adopting tools before understanding azure devops pipelines principles.**
...
1. **How measure success? — Tie blue-green deployment to SLI, DORA metric, or business KPI.**
2. **Common anti-pattern? — Adopting tools before understanding blue-green deployment principles.**
...
1. **How measure success? — Tie canary deployment to SLI, DORA metric, or business KPI.**
2. **Common anti-pattern? — Adopting tools before understanding canary deployment principles.**
...
## Q066: Build Artifact Immutability
...
1. **How measure success? — Tie build artifact immutability to SLI, DORA metric, or business KPI.**
2. **Common anti-pattern? — Adopting tools before understanding build artifact immutability principles.**
...
## Q067: Pipeline Environment Secrets
...
1. **How measure success? — Tie pipeline environment secrets to SLI, DORA metric, or business KPI.**
2. **Common anti-pattern? — Adopting tools before understanding pipeline environment secrets principles.**
...
1. **How measure success? — Tie automated testing in ci to SLI, DORA metric, or business KPI.**
2. **Common anti-pattern? — Adopting tools before understanding automated testing in ci principles.**
...
1. **How measure success? — Tie database migration in cd to SLI, DORA metric, or business KPI.**
2. **Common anti-pattern? — Adopting tools before understanding database migration in cd principles.**
...
1. **How measure success? — Tie rollback strategy ci/cd to SLI, DORA metric, or business KPI.**
2. **Common anti-pattern? — Adopting tools before understanding rollback strategy ci/cd principles.**
