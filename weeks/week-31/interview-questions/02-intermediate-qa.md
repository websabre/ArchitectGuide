...
1. **1. Coexist? — Yes with clear resource ownership boundaries.**
2. **2. AKS + multi-cloud? — Terraform or split by domain.**
...
1. **1. Workspaces vs separate state? — Separate state files for prod isolation.**
2. **2. State in Git? — Never; secrets leak in state files.**
...
1. **1. Bicep registry? — OCI artifacts for cross-subscription reuse.**
2. **2. Too many modules? — Balance granularity vs maintenance.**
...
1. **1. Intentional drift? — Break-glass with ticket and backport.**
2. **2. Black Friday freeze? — No prod IaC applies during peak.**
...
1. **1. Terraform Sentinel? — Plan-time policy for TF shops.**
2. **2. Too restrictive? — Sandbox subscription for experimentation.**
...
## Q036: Environment Promotion with IaC
...
1. **1. Ephemeral PR environments? — Deploy on PR open, destroy on close.**
2. **2. Blue-green infra? — Separate resource groups + traffic switch.**
...
1. **1. Delete and recreate? — Downtime and data loss — avoid.**
2. **2. Import all at once? — Phased by resource group.**
...
## Q038: IaC Testing in Pull Requests
...
1. **1. fmt check? — `terraform fmt -check` in CI.**
2. **2. Cost of ephemeral envs? — Budget alerts and auto-teardown.**
...
## Q039: GitOps vs Push Deployment
...
1. **1. GitOps for App Service? — Less common; Bicep pipeline is desired-state pattern.**
2. **2. Rollback? — Git revert vs redeploy artifact.**
...
1. **1. Showback? — Tags enable team cost dashboards.**
2. **2. Optional tags? — Policy should enforce, not audit only.**
...
## Q041: Bicep vs Terraform Decision Framework
...
## Q043: Terraform State Backend on Azure Storage
...
## Q045: IaC Drift Detection Automation
...
## Q047: Policy as Code with Azure Policy
...
## Q048: Bicep Parameter Files Per Environment
...
## Q049: Key Vault Secret References in IaC
...
## Q050: CI Validation for Bicep Pull Requests
...
## Q051: Terraform Workspaces vs Separate State
...
## Q052: Import Existing Azure Resources
...
## Q053: Azure Resource Naming Conventions
...
## Q054: Tagging Strategy Enforcement
...
## Q055: Landing Zone Bicep Modules
...
## Q056: Ephemeral Environments with IaC
...
## Q057: GitOps Argo CD vs Pipeline Deploy
...
## Q058: IaC Security Testing with Checkov
...
## Q059: Blast Radius via Resource Groups
...
## Q060: IaC Code Review Standards
...
## Q061: Infrastructure as Code Definition
...
1. **How measure success? — Tie infrastructure as code definition to SLI, DORA metric, or business KPI.**
2. **Common anti-pattern? — Adopting tools before understanding infrastructure as code definition principles.**
...
1. **How measure success? — Tie bicep vs arm templates to SLI, DORA metric, or business KPI.**
2. **Common anti-pattern? — Adopting tools before understanding bicep vs arm templates principles.**
...
1. **How measure success? — Tie terraform core concepts to SLI, DORA metric, or business KPI.**
2. **Common anti-pattern? — Adopting tools before understanding terraform core concepts principles.**
...
1. **How measure success? — Tie iac state management to SLI, DORA metric, or business KPI.**
2. **Common anti-pattern? — Adopting tools before understanding iac state management principles.**
...
1. **How measure success? — Tie drift detection concept to SLI, DORA metric, or business KPI.**
2. **Common anti-pattern? — Adopting tools before understanding drift detection concept principles.**
...
## Q066: GitOps for Infrastructure
...
1. **How measure success? — Tie gitops for infrastructure to SLI, DORA metric, or business KPI.**
2. **Common anti-pattern? — Adopting tools before understanding gitops for infrastructure principles.**
...
1. **How measure success? — Tie iac module reuse to SLI, DORA metric, or business KPI.**
2. **Common anti-pattern? — Adopting tools before understanding iac module reuse principles.**
...
1. **How measure success? — Tie policy as code basics to SLI, DORA metric, or business KPI.**
2. **Common anti-pattern? — Adopting tools before understanding policy as code basics principles.**
...
1. **How measure success? — Tie landing zone concept to SLI, DORA metric, or business KPI.**
2. **Common anti-pattern? — Adopting tools before understanding landing zone concept principles.**
...
## Q070: IaC Benefits Over Click-Ops
...
1. **How measure success? — Tie iac benefits over click-ops to SLI, DORA metric, or business KPI.**
2. **Common anti-pattern? — Adopting tools before understanding iac benefits over click-ops principles.**
